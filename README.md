...
[![Build Status](https://github.com/v8fg/kit4go/workflows/CI/badge.svg?branch=release)](https://github.com/v8fg/kit4go/actions?query=branch%3Arelease)
...
[![Workflow for CI Action](https://img.shields.io/github/workflow/status/v8fg/kit4go/CI?event=push&label=push)](https://github.com/v8fg/kit4go/actions/workflows/pr.yml?query=event%3Apush)
