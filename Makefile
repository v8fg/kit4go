...
SUBMODULES := adaptive aerospike cert cert/lego clickhouse elasticsearch etcd email grpcclient grpcserver kafka log4go minio metrics mongo postgres rate redis redislock tracing
