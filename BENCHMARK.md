...
| `consistenthash` Get/10nodes | ~230 | 0 | 0 |
| `consistenthash` Get/50nodes | ~996 | 0 | 0 |
| `consistenthash` Get/100nodes | ~1831 | 0 | 0 |
| `consistenthash` Get/500nodes | ~10159 | 0 | 0 |
| `consistenthash` GetN/10nodes | ~318 | 288 | 2 |
| `consistenthash` GetN/100nodes | ~2545 | 2737 | 2 |
| `consistenthash` GetN/500nodes | ~13058 | 12340 | 2 |
